			...
			<div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-6'>
				{[
					...
					},
					{
						...
						color: 'bg-gray-100 dark:bg-gray-950/30',
					},
				].map((stat) => (
									...
									<div className='flex items-start gap-4'>
										...
										<div className='flex-1 min-w-0'>
											<div className='flex items-center gap-2'>
												...
												<Badge
													className={`${statusColors[contact.status]} border-0 text-xs`}
												>
													{contact.status}
												</Badge>
											</div>
			...
			<Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
				<SheetContent className='w-full sm:max-w-md'>
					<SheetHeader>
						...
						<SheetDescription>
							View contact message and update status
						</SheetDescription>
					</SheetHeader>
						...
						<div className='space-y-6 p-6'>
							<div className='flex items-center gap-4'>
								...
								<div>
									...
									<Badge
										className={`${statusColors[selectedContact.status]} border-0`}
									>
							...
							<div className='space-y-4'>
								...
								<div className='p-3 rounded-lg bg-muted/50'>
									...
									<Select
										...
										onValueChange={(value) =>
											handleStatusChange(selectedContact._id, value)
										}
									>
